const ACCOUNTS = ['Nubank', 'Itaú', 'Bradesco', 'Inter', 'Caixa']

const CATEGORY_KEYWORDS = [
  { category: 'Mercado', terms: ['mercado', 'supermercado', 'hortifruti', 'atacadao', 'atacadão'] },
  { category: 'Alimentação', terms: ['restaurante', 'almoco', 'almoço', 'jantar', 'lanche', 'ifood', 'comida', 'padaria', 'cafe', 'café'] },
  { category: 'Combustível', terms: ['combustivel', 'combustível', 'gasolina', 'etanol', 'posto', 'abasteci'] },
  { category: 'Transporte', terms: ['uber', '99', 'taxi', 'táxi', 'metro', 'metrô', 'onibus', 'ônibus', 'estacionamento', 'pedagio', 'pedágio'] },
  { category: 'Casa', terms: ['aluguel', 'condominio', 'condomínio', 'luz', 'agua', 'água', 'internet', 'casa'] },
